...
describe('Accordian.cy.jsx', () => {
  it('rendering items in accordian', () => {
     ...
     cy.getDataTest('accordian-wrapper').within(()=>{
      cy.getDataTest('accordian-item-1').click().should('contain.text',"Your tests will exist in a describe block")
     }) 
     //better approach to target element 
     cy.getDataTest('accordian-item-1').within(()=>{
